...
import img3 from "../../assets/vectors/team3.jpg";
  ...
  return (
    <div>
      ...
      <div className=" pb-16 md:pb-24  md:pt-9 px-4 md:px-0 relative  ">
        <div
          className="absolute  h-96 md:h-102 w-full md:w-7/12   md:right-0 opacity-30 top-0"
          style={{
          ...
          <div className="flex items-center  justify-between order-last md:order-first ">
            ...
            >
              <div className="absolute right-9 top-24 pt-6 ">
                ...
                <a href="https://www.instagram.com/noorifymadrasa?igsh=OGQ5ZDc2ODk2ZA==" target="_blank"><div className="h-6 w-6 mt-2 bg-emerald-500 rounded-full flex justify-center items-center cursor-pointer hover:-translate-y-1 hover:scale-110 transition ease-linear duration-200">
                  <FaXTwitter className="text-white text-sm" />
                </div></a>
                <a href="https://www.instagram.com/noorifymadrasa?igsh=OGQ5ZDc2ODk2ZA==" target="_blank"><div className="h-6 w-6  mt-2 bg-emerald-500 rounded-full flex justify-center items-center cursor-pointer hover:-translate-y-1 hover:scale-110 transition ease-linear duration-200">
                  <FaYoutube className="text-white text-sm" />
                </div></a>
                <a href="" target="_blank"><div className="h-6 w-6 mt-2 bg-emerald-500 rounded-full flex justify-center items-center cursor-pointer hover:-translate-y-1 hover:scale-110 transition ease-linear duration-200">
                  <FaInstagram className="text-white text-sm" />
                </div></a>
                <a href="https://www.facebook.com/profile.php?id=100091635135740&mibextid=ZbWKwL" target="_blank"><div className="h-6 w-6 mt-2 bg-emerald-500 rounded-full flex justify-center items-center cursor-pointer hover:-translate-y-1 hover:scale-110 transition ease-linear duration-200">
                  <FaFacebookSquare className=" text-sm text-white" />
                </div></a>

                <a href="https://www.tiktok.com/@noorify.online.ac?_t=8iZsL7whiVu&_r=1" target="_blank"><div className="h-6 w-6 mt-2 bg-emerald-500 rounded-full flex justify-center items-center cursor-pointer hover:-translate-y-1 hover:scale-110 transition ease-linear duration-200">
            ...
            <div className="mt-6 m-auto md:m-auto  ">
              ...
              <Link href={'/pages/register'} className="m-auto md:m-0 w-fit "><button
                  className={
                    view
                      ? "bg-emerald-500 mt-10 md:mt-4 text-white py-1 px-5 rounded-sm  m-auto md:m-0  hover:-translate-y-4  -translate-y-1 transition hover:scale-105 ease-linear duration-150 "
                      : "opacity-0"
                  }
                >
                  Join Now
