                ...
                <div className="mt-10">
                  ...
                  <div className="flex mt-2">
                    <a
                      ...
                      target="_blank"
                    >
                      <FaFacebook className="text-lg text-gray-700 hover:scale-105 hover:-translate-y-0.5 transition ease-linear duration-100 cursor-pointer" />
                    </a>
                    <a
                      href="https://www.instagram.com/noorifymadrasa?igsh=OGQ5ZDc2ODk2ZA=="
                      target="_blank"
                    >
                      <FaInstagram className="text-lg text-gray-700 ml-3 hover:scale-105 hover:-translate-y-0.5 transition ease-linear duration-100 cursor-pointer" />
                    </a>
                    <a href="" target="_blank">
                      <FaXTwitter className="text-lg text-gray-700 ml-3 hover:scale-105 hover:-translate-y-0.5 transition ease-linear duration-100 cursor-pointer" />
                    </a>
                  </div>
                </div>
              </div>
